...
func _pose_attack(k: float) -> void:
	...
	match body_type:
		Enums.BodyType.FLYER, Enums.BodyType.HOVER:
...
func _pose_hit(k: float) -> void:
	...
	if body_type == Enums.BodyType.FLYER or body_type == Enums.BodyType.HOVER:
