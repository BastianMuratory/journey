...
## species lives in [code]res://data_structures/Pokemons/[/code] and is looked
...
## Normal evolution target, e.g. Sandile -> Krookodile.
@export var evolves_into: PokemonData
...
## True when there is a normal evolution to evolve into.
